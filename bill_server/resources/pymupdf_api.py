                ...
                if phone_in_page and full_name_in_page:
                    ...
                    for keyword_obj in search_keywords:
                        ...
                        for keyword_match in keyword_matches:
                            ...
                            # Check if we already found a money amount for this keyword (first occurrence only)
                            already_found = any(
                            ...
                            if money_match:
                                ...
                                # Add the first occurrence found
                                found_amounts.append(money_entry)
                                
                                # Break after finding the first money amount for this keyword on this page
                                break
            ...
            for amount in found_amounts:
                if not amount['is_sub_key']:
                    parent_entry = {
                        ...
                        'name': amount['name'],
                        'ukey': amount['ukey'],
                        'search_term': amount['search_term'],
                        'search_range_used': amount['search_range_used'],
